...
@given(u'que ingreso mi usuario "{username}" y contraseña "{password}" cambio centro trabajo preparatorias')
...
@given(u'presiono el botón Identificarse cambio centro trabajo preparatorias')
...
@given(u'entro a la página de registro de cambio centro trabajo preparatorias')
def step_impl(context):
...
@when(u'completo el formulario de constancia de cambio centro trabajo preparatorias')
def step_impl(context):
    data = {
        'curp': 'CTPW050729MMCSHNA3',
        'filiacion': 'RFC123456',
        'nombre_completo': 'John Doe',
        'categoria_plaza': 'Profesor',
        'tipo_nombramiento': '09',
        'clave_centro_trabajo': 'CENTRO123',
        'nombre_centro_trabajo': 'Escuela Preparatoria',
...
@when(u'presiono el botón de guardar constancia cambio centro trabajo preparatorias')
def step_impl(context):
